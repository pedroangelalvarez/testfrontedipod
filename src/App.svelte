...
>
  ...
  >
    ...
    <!-- PANTALLA -->
    <div
      class="w-full h-52 bg-black rounded-lg border-2 border-gray-400 overflow-hidden shadow-inner relative flex flex-col"
    >
      <!-- Backlight simulado -->
      <div
      ...
      <div class="flex-1 overflow-hidden relative">
        {#if activeSong}
          ...
          <div class="flex flex-col h-full bg-white">
            <div
              class="flex-1 flex flex-col items-center justify-center p-2 bg-gradient-to-br from-gray-800 to-black text-white relative overflow-hidden"
            >
              <!-- Reflejo simulado -->
              <div
              ...
              <div
                class="{activeSong.coverColor ||
                  'bg-gray-500'} w-24 h-24 shadow-2xl mb-2 flex items-center justify-center rounded-sm border border-white/20 overflow-hidden"
              >
